...
class HelpScreen : ThemedActionBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (i.hasExtra(Constants.EXTRA_HELP_PAGE)) {
            page =
                i.getStringExtra(Constants.EXTRA_HELP_PAGE) + "." + getText(R.string.help_locale).toString() + ".md"
        }
    ...
    fun showMarkdownAsset(wv: WebView, ctxt: Context, name: String) {
        ...
        wv.loadDataWithBaseURL(
            ...
            "text/html",
            "UTF-8",
            "file:///android_asset/index." + getText(R.string.help_locale) + ".md"
        )
    }
        ...
        when (item.itemId) {
            ...
            R.id.menu_intents -> {
                showMarkdownAsset(
                    wvHelp!!,
                    this,
                    "intents." + getText(R.string.help_locale) + ".md"
                )
                return true
            }
